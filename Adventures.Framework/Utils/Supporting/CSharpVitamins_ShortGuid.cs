...
namespace Adventures.Framework.Utils.Supporting
{
    /// <summary>
    ...
    public readonly struct ShortGuid
    {
        ...
        /// </summary>
        public readonly Guid Guid => underlyingGuid;

        /// <summary>
        /// Gets the encoded string value of the <see cref="Guid"/> as a URL-safe Base64 string.
        /// </summary>
        public readonly string Value => encodedString;

        /// <summary>
        /// Returns the encoded URL-safe Base64 string.
        /// </summary>
        /// <returns></returns>
        public override readonly string ToString() => encodedString;
